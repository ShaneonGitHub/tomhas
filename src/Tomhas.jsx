...
const PUZZLES = [
  {h:[{word:"doras",tr:"door"},{word:"léana",tr:"meadow"},{word:"séana",tr:"denial"}],v:[{word:"dílis",tr:"loyal"},{word:"réana",tr:"stripe"},{word:"séala",tr:"seal"}]},
  {h:[{word:"solas",tr:"light"},{word:"séala",tr:"seal"},{word:"amach",tr:"out"}],v:[{word:"sásta",tr:"happy"},{word:"léana",tr:"meadow"},{word:"seach",tr:"past"}]},
  {h:[{word:"básca",tr:"Basque"},{word:"séana",tr:"denial"},{word:"seach",tr:"past"}],v:[{word:"básas",tr:"death"},{word:"séala",tr:"seal"},{word:"amach",tr:"out"}]},
  {h:[{word:"doras",tr:"door"},{word:"léana",tr:"meadow"},{word:"scata",tr:"group"}],v:[{word:"dílis",tr:"loyal"},{word:"réana",tr:"stripe"},{word:"séala",tr:"seal"}]},
  {h:[{word:"doras",tr:"door"},{word:"leaba",tr:"bed"},{word:"séana",tr:"denial"}],v:[{word:"dílis",tr:"loyal"},{word:"réana",tr:"stripe"},{word:"séala",tr:"seal"}]},
  {h:[{word:"doras",tr:"door"},{word:"léana",tr:"meadow"},{word:"sean",tr:"old"}],v:[{word:"dílis",tr:"loyal"},{word:"réana",tr:"stripe"},{word:"séan",tr:"charm"}]},
  {h:[{word:"doras",tr:"door"},{word:"léana",tr:"meadow"},{word:"seas",tr:"stand"}],v:[{word:"dílis",tr:"loyal"},{word:"réana",tr:"stripe"},{word:"séan",tr:"charm"}]},
  {h:[{word:"doras",tr:"door"},{word:"léana",tr:"meadow"},{word:"suan",tr:"sleep"}],v:[{word:"dílis",tr:"loyal"},{word:"réana",tr:"stripe"},{word:"sean",tr:"old"}]},
  {h:[{word:"sásta",tr:"happy"},{word:"leaba",tr:"bed"},{word:"seach",tr:"past"}],v:[{word:"solas",tr:"light"},{word:"scata",tr:"group"},{word:"amach",tr:"out"}]},
  {h:[{word:"doras",tr:"door"},{word:"léana",tr:"meadow"},{word:"slat",tr:"rod"}],v:[{word:"dílis",tr:"loyal"},{word:"réana",tr:"stripe"},{word:"sean",tr:"old"}]},
  {h:[{word:"dreat",tr:"grimace"},{word:"rogha",tr:"choice"},{word:"seach",tr:"past"}],v:[{word:"doras",tr:"door"},{word:"eagla",tr:"fear"},{word:"teach",tr:"house"}]},
  {h:[{word:"doras",tr:"door"},{word:"léana",tr:"meadow"},{word:"sian",tr:"howl"}],v:[{word:"dílis",tr:"loyal"},{word:"réana",tr:"stripe"},{word:"séan",tr:"charm"}]},
